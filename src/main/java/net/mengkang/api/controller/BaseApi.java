...
public class BaseApi {
    ...
    public static final int VERSION_IS_TOO_LOW  = 1004;
    public static final int REQUEST_MODE_ERROR  = 1005;
    ...
    static {
        ...
        errors.put(VERSION_IS_TOO_LOW, "版本过低");
        errors.put(REQUEST_MODE_ERROR, "请求方式错误");
    }
